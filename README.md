...
## 概要
ホームページの保守・運用レポートをWEB上で一元管理できるシステムです。<br>

・管理画面では、顧客情報の管理やレポート更新通知メールの送信、操作ログの管理を行うことができます。<br>

・レポート画面では、Google Analyticsのデータを自動取得し、アクセス状況をグラフや表で分かりやすく表示します。<br>
  <div>さらに、AIによるサイト分析・評価機能や、レポートのPDFダウンロード機能にも対応しています。</div>
